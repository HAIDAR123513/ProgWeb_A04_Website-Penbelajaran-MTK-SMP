      ...
      <a class="navbar-brand text-white p-2"><b>ADMINISTRATOR</b></a>
        ...
        <div class="card-body">
            <form method="post">
                ...
                <a href="profileadmin.php" class="btn btn-danger" style ="float : right" >Batal</a>
                <button type="submit" class="btn btn-success" style ="float : right; margin-right: 4px" name="tombol_simpanadmin">Simpan</button>
            </form>
        </div>
        </div>
      </div>
